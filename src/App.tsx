          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            >
              <Link 
                ...
                className={`flex items-center gap-1 transition-colors font-semibold text-base ${isActive('/zakusky') ? 'text-brand-accent' : 'text-brand-dark hover:text-brand-accent'}`}
              >
            ...
            <Link to="/suche-pecivo" onClick={() => { window.scrollTo(0, 0); closeMenu(); }} className={`relative transition-colors font-semibold text-base ${isActive('/suche-pecivo') ? 'text-brand-accent' : 'text-brand-dark hover:text-brand-accent'}`}>
              Suché pečivo
            </Link>
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="space-y-2">
                <Link 
                  to="/zakusky" 
                  onClick={() => { window.scrollTo(0, 0); closeMenu(); }}
                  className={`block text-lg font-bold ${isActive('/zakusky') ? 'text-brand-accent' : 'text-brand-dark'}`}
                >
                  Zákusky
                </Link>
              ...
              <Link to="/suche-pecivo" onClick={() => { window.scrollTo(0, 0); closeMenu(); }} className={`block text-lg font-bold ${isActive('/suche-pecivo') ? 'text-brand-accent' : 'text-brand-dark'}`}>Suché pečivo</Link>
    ...
    <section className="relative pt-36 pb-20 lg:pt-44 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="mb-10 relative z-40 -mt-16">
              <motion.h2 
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className="text-7xl lg:text-[10rem] font-bold text-brand-dark leading-none tracking-wider uppercase"
              >
                Cukráreň
              </motion.h2>
              <motion.p 
                ...
                className="text-3xl lg:text-5xl font-semibold text-brand-accent mt-4 ml-2 tracking-wide"
              >
                Študentská
              </motion.p>
            </div>

            <h1 className="text-4xl lg:text-5xl font-bold leading-[1.1] mb-8 text-gray-800">
              Sladké momenty, <br />
          ...
          <motion.div 
            ...
            className="relative lg:col-span-7 mt-12 lg:mt-24"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link to="/suche-pecivo" onClick={() => window.scrollTo(0, 0)} className="hover:text-brand-accent transition-colors flex items-center gap-2"><ChevronRight size={14} /> Suché pečivo</Link></li>
